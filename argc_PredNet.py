...
class Argc_PredNet(Recurrent):
    '''Argc_PredNet model: This code is based on:
    ...
    statments to replace the (argcLSTM)
    ...
    # References
        - [Reduced-Gate Convolutional LSTM Architecture](https://arxiv.org/pdf/1810.07251.pdf)
